...
const AdminNotifications = () => {
  ...
  const [selectedRole, setSelectedRole] = useState("physiotherapist");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const payload = {
        ...
        message,
        targetUrl,
        recipientType: recipientType === "role" ? selectedRole : recipientType,
    ...
    <div className="flex flex-col gap-8 text-left max-w-3xl mx-auto">
      ...
      <div className="bg-white border border-slate-200/60 rounded-[32px] p-6 sm:p-10 shadow-sm">
        <form onSubmit={handleSubmit} className="flex flex-col gap-6.5">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
              ...
              <button
                ...
                className={`py-3 px-4 rounded-xl border text-xs font-bold uppercase tracking-wider transition-all cursor-pointer ${recipientType === "staff"
                  ? "bg-primary border-primary text-white shadow shadow-primary/20"
                  : "bg-slate-50 border-slate-200 text-slate-500 hover:bg-slate-100"
                  }`}
              >
              ...
              <button
                ...
                className={`py-3 px-4 rounded-xl border text-xs font-bold uppercase tracking-wider transition-all cursor-pointer ${recipientType === "patient"
                  ? "bg-primary border-primary text-white shadow shadow-primary/20"
                  : "bg-slate-50 border-slate-200 text-slate-500 hover:bg-slate-100"
                  }`}
              >
              ...
              {/* Option: Specific Staff Role */}
              <button
                type="button"
                onClick={() => setRecipientType("role")}
                className={`py-3 px-4 rounded-xl border text-xs font-bold uppercase tracking-wider transition-all cursor-pointer ${recipientType === "role"
                  ? "bg-primary border-primary text-white shadow shadow-primary/20"
                  : "bg-slate-50 border-slate-200 text-slate-500 hover:bg-slate-100"
                  }`}
              >
          ...
          {/* Conditional Dropdown for Specific Staff Role Selection */}
          {recipientType === "role" && (
