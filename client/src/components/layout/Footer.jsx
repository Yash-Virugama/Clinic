            ...
            {!user ? (
              ...
              <>
                ...
                <ul className="flex flex-col gap-2 sm:gap-3 text-xs sm:text-sm">
                  ...
                  <li>
                    <Link to="/clinic" className="hover:text-primary transition-colors duration-200">Clinic Panel</Link>
                  </li>
                  <li>
              ...
              <>
                ...
                <ul className="flex flex-col gap-2 sm:gap-3 text-xs sm:text-sm">
                  <li>
                    <Link to={`/staff/${user?.role}`} className="hover:text-primary transition-colors duration-200">Staff Panel</Link>
                  </li>
                  <li>
                    <Link to={`/staff/${user?.role}/clinic`} className="hover:text-primary transition-colors duration-200">Clinic Panel</Link>
                  </li>
                  <li>
                    <button onClick={handleLogout} className="hover:text-primary transition-colors duration-200 cursor-pointer">Logout</button>
                  </li>
